...
void Robot::setLink(){
    ...
    arm_roll_right.setInitialPositions(10070, 10.0 * 3.14/180 ,0,0);
    ...
    arm_roll_left.setInitialPositions(10050, 10.0 * 3.14/180, 0,0);
    ...
    leg_yaw_right.setInitialPositions(7420, 0.0 ,0,0);
    leg_yaw_right.setMotor(serial2, 1, REVERSE);

    leg_roll_right.setInitialPositions(6550, 0.0, 0,0);
    leg_roll_right.setMotor(serial2, 2, REVERSE);

    leg_upper_right.setInitialPositions(9550, 0.5775, 0,0);
    ...
    foot_pitch_right.setInitialPositions(5720, 0.7058, 0,0);
    foot_pitch_right.setMotor(serial2, 5, FORWARD);

    foot_roll_right.setInitialPositions(7700, 0.0, 0,0);
    ...
    leg_under_left.setInitialPositions(4320, 1.2833, 0,0);
    ...
    foot_roll_left.setInitialPositions(7280, 0.0 ,0,0);
