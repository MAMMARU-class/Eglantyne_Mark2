...
void Robot::setLink(){
    ...
    leg_roll_right.setMotor(serial2, 2, FORWARD);

    leg_upper_right.setInitialPositionsDeg(9850, -18.31, 0,0);
    leg_upper_right.setMotor(serial2, 3, FORWARD);
    ...
    foot_pitch_right.setMotor(serial2, 5, REVERSE);
    ...
    leg_upper_left.setMotor(serial2, 9, FORWARD);
